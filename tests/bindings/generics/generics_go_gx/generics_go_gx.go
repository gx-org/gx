...
// Package generics_go_gx are Go bindings to the GX package:
// github.com/gx-org/gx/tests/bindings/generics.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package generics_go_gx
...
// BuildFor loads the GX package github.com/gx-org/gx/tests/bindings/generics
...
// BuildHandleFor loads the GX package github.com/gx-org/gx/tests/bindings/generics
...
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("github.com/gx-org/gx/tests/bindings/generics")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
