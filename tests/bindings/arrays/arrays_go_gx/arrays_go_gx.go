...
// Package arrays_go_gx are Go bindings to the GX package:
// github.com/gx-org/gx/tests/bindings/arrays.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package arrays_go_gx
...
import (
	...
	_ "github.com/gx-org/gx/tests/bindings/arrays"
)
...
// BuildFor loads the GX package github.com/gx-org/gx/tests/bindings/arrays
...
// BuildHandleFor loads the GX package github.com/gx-org/gx/tests/bindings/arrays
...
type Package struct {
	...
	cacheArgAsArrayIndex *core.FuncCache
}

// Build builds a package for a device once it has been loaded.
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("github.com/gx-org/gx/tests/bindings/arrays")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
	...
	pkg.cacheArgAsArrayIndex, err = pkg.handle.NewCache("", "ArgAsArrayIndex")
	if err != nil {
		return nil, err
	}
...
// ArgAsArrayIndex returns a value indexing an array.
func (pkg *Package) ArgAsArrayIndex(arg0 types.Atom[int]) (_ types.Atom[float32], err error) {
	var args []values.Value = []values.Value{
		arg0.Bridge().GXValue(), // i int
	}
	var runner tracer.CompiledFunc
	runner, err = pkg.cacheArgAsArrayIndex.Runner(nil, args)
	if err != nil {
		return
	}
