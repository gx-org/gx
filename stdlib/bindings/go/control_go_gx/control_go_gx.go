...
// Package control_go_gx are Go bindings to the GX package:
// control.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package control_go_gx
...
// BuildFor loads the GX package control
...
// BuildHandleFor loads the GX package control
...
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("control")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
