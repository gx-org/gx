...
// Package cperrors_go_gx are Go bindings to the GX package:
// cperrors.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package cperrors_go_gx
...
import (
	...
	gxdep0 "github.com/gx-org/gx/stdlib/bindings/go/fmt_go_gx"
)
...
// BuildFor loads the GX package cperrors
...
// BuildHandleFor loads the GX package cperrors
...
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("cperrors")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
