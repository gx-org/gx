...
// Package fmt_go_gx are Go bindings to the GX package:
// fmt.
//
...
import (
	...
	gxdep0 "github.com/gx-org/gx/stdlib/bindings/go/errors_go_gx"
)
...
// BuildFor loads the GX package fmt
...
// BuildHandleFor loads the GX package fmt
...
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("fmt")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
