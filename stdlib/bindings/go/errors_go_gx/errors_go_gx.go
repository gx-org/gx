...
// Package errors_go_gx are Go bindings to the GX package:
// errors.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package errors_go_gx
...
// BuildFor loads the GX package errors
...
// BuildHandleFor loads the GX package errors
...
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("errors")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
