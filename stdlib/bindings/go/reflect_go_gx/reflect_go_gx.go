...
// Package reflect_go_gx are Go bindings to the GX package:
// reflect.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package reflect_go_gx
...
// BuildFor loads the GX package reflect
...
// BuildHandleFor loads the GX package reflect
...
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("reflect")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
