...
// Package cmperr compares errors returned by the compiler with expected errors
// declared in the source code and available in the intermediate representation.
package cmperr
...
// Compare removes errors declared in the source code using:
...
func Compare(pkg *ir.Package, err error) (int, error) {
