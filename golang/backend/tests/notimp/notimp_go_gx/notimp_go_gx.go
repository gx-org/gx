...
// Package notimp_go_gx are Go bindings to the GX package:
// github.com/gx-org/gx/golang/backend/tests/notimp.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package notimp_go_gx
...
import (
	...
	_ "github.com/gx-org/gx/golang/backend/tests/notimp"
...
// BuildFor loads the GX package github.com/gx-org/gx/golang/backend/tests/notimp
...
// BuildHandleFor loads the GX package github.com/gx-org/gx/golang/backend/tests/notimp
...
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("github.com/gx-org/gx/golang/backend/tests/notimp")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
