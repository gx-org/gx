...
// Package interperr_go_gx are Go bindings to the GX package:
// github.com/gx-org/gx/golang/backend/tests/interperr.
//
// Automatically generated by
// gx/golang/binder/gobindings/bindings.go.tmpl.
package interperr_go_gx
...
import (
	...
	_ "github.com/gx-org/gx/golang/backend/tests/interperr"
...
// BuildFor loads the GX package github.com/gx-org/gx/golang/backend/tests/interperr
...
// BuildHandleFor loads the GX package github.com/gx-org/gx/golang/backend/tests/interperr
...
type Package struct {
	...
	cacheCallSum  *core.FuncCache
	cacheNewUndef *core.FuncCache
}

// Build builds a package for a device once it has been loaded.
func Build(dev *core.DeviceSetup) (*PackageHandle, error) {
	bpkg, err := dev.Runtime().Builder().Build("github.com/gx-org/gx/golang/backend/tests/interperr")
	if err != nil {
		return nil, err
	}
	pkg := &Package{}
	...
	pkg.cacheCallSum, err = pkg.handle.NewCache("", "CallSum")
	if err != nil {
		return nil, err
	}
	pkg.cacheNewUndef, err = pkg.handle.NewCache("", "NewUndef")
	if err != nil {
		return nil, err
	}
...
func (pkg *Package) CallSum() (_ types.Atom[float32], err error) {
	var args []values.Value = nil
	var runner tracer.CompiledFunc
	runner, err = pkg.cacheCallSum.Runner(nil, args)
	if err != nil {
		return
	}
...
func (pkg *Package) NewUndef() (_ types.Array[float32], err error) {
	var args []values.Value = nil
	var runner tracer.CompiledFunc
	runner, err = pkg.cacheNewUndef.Runner(nil, args)
	if err != nil {
		return
	}
	var outputs []values.Value
