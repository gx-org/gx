...
// cgx_list_functions_result is the return value when listing functions of a GX
// element.
...
// cgx_function_signature_element describes a function parameter or return
// value.
...
// cgx_function_signature_result is the return value for
// cgx_function_signature().
...
extern struct cgx_device_get_result cgx_device_get(cgx_runtime cgxRuntime,
                                                   GoInt deviceIdx);
extern cgx_runtime cgx_device_get_runtime(cgx_device cgxDevice);
extern struct cgx_package_ir_load_result
cgx_package_ir_load(cgx_runtime cgxRuntime, cchar_t *pathPtr);
extern cgx_package cgx_package_ir_build_for(cgx_package_ir cgxPackageIR,
                                            cgx_device cgxDevice);
...
extern struct cgx_list_functions_result
cgx_package_list_functions(cgx_package cgxPackage);
extern cgx_package_ir cgx_package_get_ir(cgx_package cgxPackage);
extern void
cgx_free_list_functions_result(struct cgx_list_functions_result *res);
extern struct cgx_interface_find_result
cgx_interface_find(cgx_package cgxPackage, cchar_t *cname);
extern struct cgx_function_find_result cgx_function_find(cgx_package cgxPackage,
                                                         cchar_t *funcNamePtr);
extern struct cgx_function_run_result cgx_function_run(cgx_function cgxFunction,
                                                       cgx_value cgxReceiver,
                                                       int argCount,
                                                       cgx_value *args);
extern cchar_t *cgx_function_name(cgx_function cgxFunction);
extern cchar_t *cgx_function_doc(cgx_function cgxFunction);
extern struct cgx_function_signature_result
cgx_function_signature(cgx_function cgxFunction);
extern void cgx_free_function_signature_result(
    struct cgx_function_signature_result *cgxSignature);
extern GoInt cgx_function_num_params(cgx_function cgxFunction);
extern enum cgx_value_kind cgx_function_param_dtype(cgx_function cgxFunction,
                                                    GoInt arg);
extern void
cgx_free_function_run_result(struct cgx_function_run_result *cgxFunctionResult);
extern struct cgx_value_new_result cgx_value_new_bool(cgx_device cgxDevice,
                                                      _Bool value);
extern struct cgx_value_new_result cgx_value_new_float32(cgx_device cgxDevice,
                                                         float value);
extern struct cgx_value_new_result cgx_value_new_float64(cgx_device cgxDevice,
                                                         double value);
extern struct cgx_value_new_result cgx_value_new_int32(cgx_device cgxDevice,
                                                       int32_t value);
extern struct cgx_value_new_result cgx_value_new_int64(cgx_device cgxDevice,
                                                       int64_t value);
extern struct cgx_value_new_result cgx_value_new_uint32(cgx_device cgxDevice,
                                                        uint32_t value);
extern struct cgx_value_new_result cgx_value_new_uint64(cgx_device cgxDevice,
                                                        uint64_t value);
extern struct cgx_value_new_result cgx_value_send(cgx_device cgxDevice,
                                                  cgx_shape cgxShape,
                                                  cvoid_t *data,
                                                  uint64_t dataSize);
...
extern struct cgx_value_host_buffer_result
cgx_value_host_buffer(cgx_value cgxValue);
extern struct cgx_value_get_struct_result
cgx_value_get_struct(cgx_value cgxValue);
extern cgx_interface cgx_value_get_interface_type(cgx_device cgxDevice,
                                                  cgx_value cgxValue);
extern cchar_t *cgx_value_string(cgx_value cgxValue);
extern cgx_shape cgx_shape_new(enum cgx_value_kind dtype, cint64_t *axisLengths,
                               int axisLengthsSize);
extern struct cgx_shape_axes_result cgx_shape_axes(cgx_shape cgxShape);
extern void
cgx_free_shape_axes_result(struct cgx_shape_axes_result *cgxShapeResult);
...
extern void cgx_host_buffer_release_data(cgx_host_buffer cgxHostBuffer,
                                         char *data);
extern struct cgx_value_new_result cgx_struct_field_get(cgx_struct cgxStruct,
                                                        cchar_t *fieldNamePtr);
extern cgx_error cgx_struct_field_set(cgx_struct cgxStruct,
                                      cchar_t *fieldNamePtr,
                                      cgx_value cgxValue);
extern struct cgx_struct_field_list_result
cgx_struct_field_list(cgx_struct cgxStruct);
extern void cgx_free_struct_field_list_result(
    struct cgx_struct_field_list_result *cgxFieldList);
extern struct cgx_function_find_result
cgx_interface_method_find(cgx_interface cgxIFace, cchar_t *methodNamePtr);
extern cchar_t *cgx_interface_name(cgx_interface cgxIFace);
extern cchar_t *cgx_interface_package_name(cgx_interface cgxIFace);
extern struct cgx_list_functions_result
cgx_interface_list_methods(cgx_interface cgxIFace);
